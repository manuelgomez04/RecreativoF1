insert into presupuesto (id_presupuesto, gastos_fijos, gastos_variables, ingresos_fijos, ingresos_variables, presupuesto_inicial) values (1, 0 ,ROUND(RANDOM()*1000000),ROUND(RANDOM()*10000000),0,ROUND(RANDOM()*10000000));
