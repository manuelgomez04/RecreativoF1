insert into presupuesto (id_presupuesto, gastosfijos, gastosvariables, ingresos_fijos, ingresos_variables, presupuesto_inicial) values (1, 200, 500, 0, 67, 0);
